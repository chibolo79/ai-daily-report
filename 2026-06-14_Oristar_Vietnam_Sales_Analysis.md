...
**세일즈 현황**:
- **DSR 수요 품목**: SWOSC-B DIA 4.20MM (HONDA 클러치용, 주력). STS WIRE 소량(설비 기준 월 약 1톤 수준). OVAL TYPE WIRE(SWOSC-V 또는 VH) 수요 검토 이력 있음 — 용도는 이너 드로잉 또는 SPRING
