...
**회사 개요**: 대만계 spring maker. 자동차 및 이륜차 관련 spring 제조. DSR-ORISTAR-YANGMIN 구조로 직접 커뮤니케이션 가능. 홈페이지 기준 automotive lowering spring, mold spring, motorcycle clutch spring, OEM industrial spring 생산.

**세일즈 현황**:
- 주력 품목: **SWOSC-B DIA 4.20MM** (clutch용). 2022년 월 약 150톤 수준
- 2023년 ORISTAR 통해 공급량 약 160톤으로 증가했으나, HONDA 수요 감소로 약 120톤 수준 하락 가능성 있음
- OT WIRE는 대만, 중국, 한국산 복수 공급처 운영 중. ORISTAR 통해 KIS, SAMHWA도 주요 거래처로 파악됨
- STS WIRE 사용은 소량 (작업 설비 기준 월 1톤 수준)
...
**FOLLOW UP**: SWOSC-B 4.20MM 수요 변화 면밀히 추적. Honda 클러치 부품 물량 동향 및 신규 프로젝트(OT/IT Wire) 파이프라인 확인. TH1524 품질 이슈 해소 여부 확인 필요.
